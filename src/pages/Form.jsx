...
import { InputHora } from "../components/Form/ImputHora";
...
export const Form = () => {
  ...
  return (
    <form id="form" onSubmit={handleSubmit}>
      ...
      {/*         Duracion y Valor             */}
      <div className="form-row">
        <InputDuracion className="duracion-form-input" value={formTurno?.duracion} />
